...
public class Submarine extends JLabel implements Runnable {
    ...
    private  ImageIcon[][] imgIcon={{new ImageIcon("img/1.png"),new ImageIcon("img/2.png"),
            new ImageIcon("img/3.png")},{new ImageIcon("img/111.png"),new ImageIcon("img/222.png"),new ImageIcon("img/333.png")}};
